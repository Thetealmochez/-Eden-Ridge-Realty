        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl font-semibold text-luxury-navy mb-4">Our Vision & Mission</h2>
              <div className="w-20 h-1 bg-luxury-gold mx-auto mb-6"></div>
              <p className="text-luxury-slate">
                Driving the future of luxury real estate in Kenya through innovation, excellence, and unwavering commitment to our clients.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="bg-gray-50 p-8 rounded-lg">
                ...
                <h3 className="text-2xl font-semibold text-luxury-navy mb-4">Our Vision</h3>
                <p className="text-luxury-slate leading-relaxed">
                  To be Kenya's most trusted and innovative luxury real estate company, setting the standard for excellence in property services across East Africa. We envision a future where every client experiences seamless, personalized service that transforms their real estate dreams into reality, while contributing to the sustainable development of Kenya's most prestigious communities.
                </p>
              </div>
              
              {/* Mission */}
              <div className="bg-luxury-navy p-8 rounded-lg">
                ...
                <p className="text-white/90 leading-relaxed">
                  To provide exceptional luxury real estate services that exceed client expectations through deep market expertise, innovative technology, and personalized attention. We are committed to connecting discerning clients with Kenya's finest properties while maintaining the highest standards of integrity, professionalism, and service excellence in every transaction.
                </p>
              </div>
            </div>
          </div>

...
const Footer = () => {
  ...
  return (
    <footer className="bg-luxury-navy text-white pt-16 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-white/70 mb-6">
              Subscribe to receive updates on new premium properties and market insights.
            </p>
            <div className="flex flex-col space-y-3">
              <Input 
                placeholder="Your email address" 
                className="bg-luxury-navy/50 border border-white/20 text-white" 
              />
              <Button className="bg-luxury-gold hover:bg-luxury-gold/90 text-luxury-navy w-full">
                Subscribe
              </Button>
            </div>
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-white/10 text-white p-2 rounded-full hover:bg-luxury-gold hover:text-luxury-navy luxury-transition">

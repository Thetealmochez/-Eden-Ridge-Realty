...
const PropertyResults: React.FC<PropertyResultsProps> = ({
  ...
  // Safely handle filteredProperties
  const safeProperties = Array.isArray(filteredProperties) ? filteredProperties : [];
  
  return (
    <div className="container mx-auto px-4 py-16">
      <h2 className="text-3xl font-semibold text-luxury-navy mb-2">
        {safeProperties.length} {safeProperties.length === 1 ? 'Property' : 'Properties'} Found
      </h2>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-luxury-slate mb-6">Try adjusting your filters to see more results, or check back later for new listings.</p>

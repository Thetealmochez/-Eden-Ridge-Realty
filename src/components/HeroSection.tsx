...
const HeroSection = () => {
  ...
  return (
    <div className="relative h-screen w-full bg-[url('/images/hero-bg.jpg')] bg-cover bg-center bg-fixed">
      <div className="absolute inset-0 bg-gradient-to-b from-luxury-navy/70 to-luxury-navy/50 flex flex-col justify-center items-center px-4">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white mb-6 animate-fade-in-up">
            Find Your Dream <span className="text-luxury-gold animate-float">Kenyan</span> Home
          </h1>
          <p className="text-xl md:text-2xl text-white/90 mb-10 max-w-3xl mx-auto animate-fade-in-up" style={{ animationDelay: '150ms' }}>
            Exclusive properties in Nairobi, Mombasa, and Kenya's most prestigious locations
          </p>
          
          <div className="bg-white/95 backdrop-blur-sm rounded-lg p-4 md:p-6 max-w-4xl mx-auto shadow-xl animate-scale-in" style={{ animationDelay: '300ms' }}>
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-6 animate-slide-in-right" style={{ animationDelay: '500ms' }}>
            <div className="bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full hover:bg-white/20 transition-all duration-300 hover:scale-105 transform">
              <p className="text-white text-sm"><span className="font-bold">500+</span> Premium Listings</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full hover:bg-white/20 transition-all duration-300 hover:scale-105 transform" style={{ animationDelay: '600ms' }}>
              <p className="text-white text-sm"><span className="font-bold">200+</span> Happy Clients</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full hover:bg-white/20 transition-all duration-300 hover:scale-105 transform" style={{ animationDelay: '700ms' }}>
